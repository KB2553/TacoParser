...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // in the logger below, multiply the distance by 0.000621371 to return the distance in Miles.
            logger.LogInfo($"The two locations farthest apart are { tacoBell1.Name} and { tacoBell2.Name}, with a distance of {distance * 0.000621371} miles apart.");
        }
    }
}
